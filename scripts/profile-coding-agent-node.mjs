...
const agentDirEnvName = "IROPI_CODING_AGENT_DIR";
...
Options:
  ...
  --agent-dir <dir>      Use a specific IROPI_CODING_AGENT_DIR for the benchmark run
...
async function runTuiBenchmarkRun({ runtime, runIndex, measuredIndex, options, profileDir }) {
	...
	const tempRoot = options.isolatedAgentDir ? mkdtempSync(join(tmpdir(), "iropi-startup-benchmark-")) : undefined;
