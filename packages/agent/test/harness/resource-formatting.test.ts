...
describe("resource formatting helpers", () => {
	it("formats skill invocations with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.iropi/skills/inspect/SKILL.md",
		};

		expect(formatSkillInvocation(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.iropi/skills/inspect/SKILL.md">\nReferences are relative to /project/.iropi/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});
