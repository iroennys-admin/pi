...
```bash
npm install @iroennys/iropi-ai
```

TypeBox exports are re-exported from `@iroennys/iropi-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@iroennys/iropi-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@iroennys/iropi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@iroennys/iropi-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@iroennys/iropi-ai';
...
```typescript
import { getImageModel, generateImages } from '@mariozechner/iropi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@iroennys/iropi-ai';
...
```typescript
import { getModel, stream } from '@iroennys/iropi-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@iroennys/iropi-ai';
...
```typescript
import { Model, stream } from '@iroennys/iropi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@iroennys/iropi-ai';
...
```typescript
import { getModel, complete, Context } from '@iroennys/iropi-ai';
...
```typescript
import { Context, getModel, complete } from '@iroennys/iropi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@iroennys/iropi-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@iroennys/iropi-ai';
...
```bash
npx @iroennys/iropi-ai login              # interactive provider selection
npx @iroennys/iropi-ai login anthropic    # login to specific provider
npx @iroennys/iropi-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@iroennys/iropi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@iroennys/iropi-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@iroennys/iropi-ai/oauth';
...
```typescript
import { getModel, complete } from '@iroennys/iropi-ai';
import { getOAuthApiKey } from '@iroennys/iropi-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@iroennys/iropi-ai`
