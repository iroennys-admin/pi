...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/iroennys-admin/iropi-mono/releases/latest`;
	}
	const command = getSelfUpdateCommandForMethod(method, packageName, updatePackageName, npmCommand);
	if (command) {
...
export function getPackageDir(): string {
	...
	const envDir = process.env.IROPI_PACKAGE_DIR;
	if (envDir) {
...
export const PACKAGE_NAME: string = pkg.name || "@iroennys/iropi-coding-agent";
export const APP_NAME: string = piConfigName || "iropi";
export const APP_TITLE: string = piConfigName ? APP_NAME : "IROPI";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".iropi";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., IROPI_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
const DEFAULT_SHARE_VIEWER_URL = "https://iropi.dev/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.IROPI_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.iropi/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.iropi/agent/) */
