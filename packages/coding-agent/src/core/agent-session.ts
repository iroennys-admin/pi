...
import type { Agent, AgentEvent, AgentMessage, AgentState, AgentTool, ThinkingLevel } from "@iroennys/iropi-agent-core";
import type { AssistantMessage, ImageContent, Message, Model, TextContent } from "@iroennys/iropi-ai";
import {
	clampThinkingLevel,
...
export class AgentSession {
	 ...
	 * - Handles extension commands (registered via iropi.registerCommand) immediately, even during streaming
	...
	async prompt(text: string, options?: PromptOptions): Promise<void> {
		...
		try {
			...
			// Extension commands manage their own LLM interaction via iropi.sendMessage()
