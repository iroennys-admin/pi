...
/**
 * Regression test for https://github.com/iroennys-admin/iropi-mono/issues/2791
 *
...
process.env.IROPI_CODING_AGENT_DIR = "${agentDir}";
...
`,
		...
		try {
			_stdout = execFileSync(process.execPath, [scriptPath], {
				timeout: 10000,
				encoding: "utf-8",
				env: { ...process.env, IROPI_CODING_AGENT_DIR: agentDir },
