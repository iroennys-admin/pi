...
import { Text, type TUI } from "@iroennys/iropi-tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".iropi", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .iropi/AGENTS.md",
	...
	for (const scenario of [
		...
		{ title: "IROPI documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
