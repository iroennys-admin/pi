...
import { Agent, type AgentEvent, type AgentTool } from "@iroennys/iropi-agent-core";
import { type AssistantMessage, type AssistantMessageEvent, EventStream, getModel } from "@iroennys/iropi-ai";
