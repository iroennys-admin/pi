...
import type { AssistantMessage, Model } from "@iroennys/iropi-ai";
...
vi.mock("@iroennys/iropi-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@iroennys/iropi-ai")>();
	return {
		...actual,
