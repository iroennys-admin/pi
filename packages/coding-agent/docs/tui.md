...
**Source:** [`@iroennys/iropi-tui`](https://github.com/iroennys-admin/iropi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@iroennys/iropi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@iroennys/iropi-tui";
...
Import from `@iroennys/iropi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@iroennys/iropi-tui";
```
...
```typescript
import { matchesKey, Key } from "@iroennys/iropi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@iroennys/iropi-tui";
...
```typescript
import { getMarkdownTheme } from "@iroennys/iropi-coding-agent";
import { Markdown } from "@iroennys/iropi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@iroennys/iropi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@iroennys/iropi-coding-agent";
import { DynamicBorder } from "@iroennys/iropi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@iroennys/iropi-tui";
...
```typescript
import { BorderedLoader } from "@iroennys/iropi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@iroennys/iropi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@iroennys/iropi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@iroennys/iropi-tui";
...
import { matchesKey, truncateToWidth } from "@iroennys/iropi-tui";
