...
For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @iroennys/iropi-coding-agent`, `yarn global remove @iroennys/iropi-coding-agent`, or `bun uninstall -g @iroennys/iropi-coding-agent`.
