...
Discovery rules:
- In `~/.iropi/agent/skills/` and `.iropi/skills/`, direct root `.md` files are discovered as individual skills
...
For project-level Claude Code skills, add to `.iropi/settings.json`:
