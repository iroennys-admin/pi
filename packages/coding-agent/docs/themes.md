...
- Built-in: `dark`, `light`
- Global: `~/.iropi/agent/themes/*.json`
- Project: `.iropi/themes/*.json` (only after the project is trusted)
...
```bash
mkdir -p ~/.iropi/agent/themes
vim ~/.iropi/agent/themes/my-theme.json
```
...
```json
{
  "$schema": "https://raw.githubusercontent.com/iroennys-admin/pi/main/packages/coding-agent/src/modes/interactive/theme/theme-schema.json",
  "name": "my-theme",
  "vars": {
    "primary": "#00aaff",
    "secondary": 242
