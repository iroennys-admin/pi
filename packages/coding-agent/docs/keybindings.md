...
All keyboard shortcuts can be customized via `~/.iropi/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.iropi/agent/keybindings.json`:
