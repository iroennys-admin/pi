...
import { createAgentSession, DefaultResourceLoader, getAgentDir, SessionManager } from "@iroennys/iropi-coding-agent";
...
export default function (iropi: ExtensionAPI) {
	...
	iropi.on("agent_end", async (event) => {
	...
	// Register a command
	iropi.registerCommand("mycommand", {
