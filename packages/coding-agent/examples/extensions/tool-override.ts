 ...
 *
 * Usage:
 *   iropi -e ./tool-override.ts
 */

import type { TextContent } from "@iroennys/iropi-ai";
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@iroennys/iropi-coding-agent";
...
export default function (iropi: ExtensionAPI) {
	...
	iropi.registerCommand("read-log", {
