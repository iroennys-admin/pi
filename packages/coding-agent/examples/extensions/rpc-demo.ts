...
export default function (iropi: ExtensionAPI) {
        ...
        iropi.on("session_start", async (event, ctx) => {
                ctx.ui.setTitle(event.reason === "new" ? "IROPI RPC Demo (new session)" : "IROPI RPC Demo");
        ...
        iropi.on("session_before_switch", async (event, ctx) => {
        ...
        iropi.registerCommand("rpc-input", {
        ...
        iropi.registerCommand("rpc-editor", {
        ...
        iropi.registerCommand("rpc-prefill", {
