 ...
 *
 * Usage: iropi --extension ./examples/extensions/overlay-qa-tests.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@iroennys/iropi-coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@iroennys/iropi-tui";
import { Input, matchesKey, truncateToWidth, visibleWidth } from "@iroennys/iropi-tui";
...
export default function (iropi: ExtensionAPI) {
	...
	iropi.registerCommand("overlay-animation", {
	...
	iropi.registerCommand("overlay-anchors", {
	...
	iropi.registerCommand("overlay-margins", {
	...
	iropi.registerCommand("overlay-stack", {
	...
	iropi.registerCommand("overlay-overflow", {
	...
	iropi.registerCommand("overlay-edge", {
	...
	iropi.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	iropi.registerCommand("overlay-maxheight", {
	...
	iropi.registerCommand("overlay-sidepanel", {
	...
	iropi.registerCommand("overlay-toggle", {
	...
	iropi.registerCommand("overlay-passive", {
	...
	iropi.registerCommand("overlay-focus", {
	...
	iropi.registerCommand("overlay-streaming", {
