 ...
 *
 * Usage:
 *   iropi -e ./ssh.ts --ssh user@host
 *   iropi -e ./ssh.ts --ssh user@host:/remote/path
 *
 * Requirements:
...
export default function (iropi: ExtensionAPI) {
	iropi.registerFlag("ssh", { description: "SSH remote: user@host or user@host:/path", type: "string" });
