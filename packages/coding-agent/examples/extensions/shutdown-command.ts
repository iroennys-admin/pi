...
export default function (iropi: ExtensionAPI) {
	...
	iropi.registerCommand("quit", {
		description: "Exit iropi cleanly",
	...
	iropi.registerTool({
		...
		description: "Complete a task and exit iropi",
	...
	iropi.registerTool({
		...
		description: "Deploy the application and exit iropi",
		parameters: Type.Object({
		...
		async execute(_toolCallId, params, _signal, onUpdate, ctx) {
			...
			// const result = await iropi.exec("npm", ["run", "deploy", params.environment], { signal });
