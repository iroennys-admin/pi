 ...
 *
 * Usage: iropi --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@iroennys/iropi-tui";

export default function (iropi: ExtensionAPI) {
	iropi.registerCommand("overlay-test", {
