 ...
 *   iropi -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... iropi -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (iropi: ExtensionAPI) {
	iropi.registerProvider("custom-anthropic", {
